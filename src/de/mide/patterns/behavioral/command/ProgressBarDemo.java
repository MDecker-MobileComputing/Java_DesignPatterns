package de.mide.patterns.behavioral.command;
...
/**
 * Program with Swing to demonstrate usage of command pattern
 * with a background/worker thread that updates a progress bar.  
 */
